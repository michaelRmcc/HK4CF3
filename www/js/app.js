...
.run(function($ionicPlatform, $rootScope, $ionicLoading) {
  $ionicPlatform.ready(function() {
	...
	$rootScope.$on('$stateChangeSuccess', function() {
		console.log('statc changes success, done');
        ...
        templateUrl: 'templates/home.html',
			...
			resolve: {
					leader: ['corporateFactory', function(corporateFactory) {
						console.log("home. corporateFactory call next.");
						return corporateFactory.get({id: parseInt(0,10)}); 
						}],
					dish: ['$stateParams', 'menuFactory', function($stateParams, 	menuFactory) {
						//return menuFactory.get({id:parseInt($stateParams.id, 10)});
						return menuFactory.get({id: parseInt(1,10)});
						}],			
      ...
      views: {
        'mainContent': {
          templateUrl: 'templates/aboutus.html',
				...
				resolve: {
						leaders: ['$stateParams','corporateFactory', function($stateParams, corporateFactory) {
